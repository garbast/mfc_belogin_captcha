...
class LoginControllerSlot
{
    ...
    protected function renderCaptchaError($form)
    {
        if (isset($GLOBALS['T3_VAR']['recaptcha_error'])) {
            ...
            $template = $this->markerBasedTemplateService->getSubpart($GLOBALS['TBE_TEMPLATE']->moduleTemplate,
                '###CAPTCHA_ERROR###');
        ...
        return $this->markerBasedTemplateService->substituteSubpart($form, '###CAPTCHA_ERROR###', '');
    }
